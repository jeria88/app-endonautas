    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('somatic_tag', models.CharField(blank=True, choices=[('cuerpo', 'Cuerpo'), ('mente', 'Mente'), ('emociones', 'Emociones'), ('vinculos', 'Vínculos'), ('proposito', 'Propósito'), ('sombra', 'Sombra')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reaction_type', models.CharField(choices=[('resonar', 'Resuena'), ('gracias', 'Gracias'), ('fuerza', 'Fuerza')], max_length=20)),
