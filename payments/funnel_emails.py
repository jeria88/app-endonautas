...
def enviar_A1(order):
    ...
    cuerpo = (
        f'{_saludo(nombre)}escribiste tu correo para llevarte Endonáutica y algo '
...
def enviar_A2(order):
    ...
    cuerpo = (
        ...
        'mirar para afuera.\n\n'
        'Endonáutica no es un libro para sentirte mejor un rato. Es un sistema para '
...
def enviar_P3(order):
    ...
    cuerpo = (
        ...
        'Endonáutica es la primera pieza de algo más grande. La siguiente es el '
...
def enviar_T2(lead):
    ...
    cuerpo = (
        ...
        'costo es energía.\n\n'
        f'{bloque_frase}'
        'Sostener una máscara todo el día cansa de un modo que el descanso no '
        'arregla — es energía que gastas sin darte cuenta, solo por mantener la '
        'guardia.\n\n'
        'En Endonáutica desarmo esa máscara pieza por pieza: de dónde salió, qué te '
        'costó construirla, y qué hacer cuando ya no te sirve. No es filosofía — es '
        'un mapa que ya está operando dentro de ti.\n\n'
...
def enviar_T3(lead):
    ...
    cuerpo = (
        ...
        f'Endonáutica cuesta {_precio()}. 205 páginas: las cinco heridas, las '
        'máscaras, la sombra, el mapa de niveles de conciencia. '
